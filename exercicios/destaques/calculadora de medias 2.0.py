...
for i in range(quantidade_notas):
    while True:
        try:
            ...
            print("Entrada inválida. Digite um número (ex: 8.5).")

# Cálculo e Exclusão
if notas: # Garante que a lista não está vazia
    ...
    # Isso só ocorreria se o sys.exit() falhasse, mas é bom ter
    media = 0 
...
print(f"Soma ajustada: {soma_ajustada:.2f}")
